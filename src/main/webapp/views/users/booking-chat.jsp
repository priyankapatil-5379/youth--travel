...
<head>
    ...
    <title>Chat: ${booking.trip.title} | Youth Travel</title>
    ...
    <style>
        ...
        .msg-received .sender-label { font-size: 12px; font-weight: 700; color: #22c55e; margin-bottom: 5px; display: block; }
...
<body>
    <header class="header">
        ...
        <div style="display: flex; align-items: center; gap: 20px;">
            <a href="<c:url value='/user/my-bookings'/>" style="color: #fff; text-decoration: none; font-weight: 700; font-size: 14px;"><i class="fa fa-arrow-left"></i> Back to Bookings</a>
        </div>
    </header>
    ...
    <div class="chat-container">
        <div class="chat-header">
            <div class="chat-header-info">
                ...
                <div>
                    <h3 style="margin: 0; font-size: 18px; font-weight: 800;">${booking.vendor.businessName}</h3>
                    <div style="font-size: 13px; color: var(--text-muted);">Regarding: <span style="color: #fff;">${booking.trip.title}</span></div>
                </div>
            </div>
            <div><span class="status-badge" style="background: rgba(34, 197, 94, 0.1); color: #22c55e; padding: 5px 12px; border-radius: 20px; font-weight: 700; font-size: 12px;">Booking ID: #${booking.id}</span></div>
        </div>
                ...
                <c:choose>
                    <c:when test="${msg.isFromVendor()}">
                        <div class="msg-bubble msg-received">
                            <span class="sender-label">${booking.vendor.businessName} (Vendor)</span>
                            ${msg.content}
        ...
        <div class="chat-input-area">
            <form class="chat-form" action="<c:url value='/user/booking/${booking.id}/chat'/>" method="post">
                <input type="text" name="content" class="chat-input" placeholder="Type your message here..." required autocomplete="off">
