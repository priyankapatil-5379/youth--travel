...
<head>
    ...
    <style>
        ...
        .package-card:hover .package-img, .package-card:hover .package-video { transform: scale(1.1); }
        ...
        .package-info { padding: 15px 20px; flex: 1; display: flex; flex-direction: column; }
        .package-name { 
            font-size: 17px; 
            font-weight: 800; 
            color: var(--text-main); 
        ...
        .package-meta { font-size: 13px; color: var(--text-muted); margin-bottom: 4px; display: flex; align-items: center; gap: 8px; font-weight: 500; }
        .package-meta i { color: var(--primary); width: 14px; font-size: 14px; }
        ...
        .package-price { font-size: 19px; font-weight: 900; color: var(--text-main); }
        .package-price span { font-size: 12px; font-weight: 500; color: var(--text-muted); }
        ...
        .btn-view:hover { background: var(--primary-hover); transform: scale(1.05); }
        ...
        .category-title { font-size: 20px; font-weight: 800; color: var(--text-main); margin: 0; letter-spacing: -0.5px; }
        .bg-danger-soft { background: #fee2e2 !important; color: #ef4444 !important; border-radius: 8px; padding: 6px 12px; font-size: 12px; }
        ...
        @media (max-width: 1200px) {
            ...
            .package-grid { grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); }
        }

        @media (max-width: 991px) {
            .mobile-header { display: flex; }
            .main-content { margin-left: 0; padding: 70px 0 0 !important; }
            ...
            .sort-select { flex: 1; }
            .package-grid { grid-template-columns: repeat(2, 1fr); justify-content: center; }
        ...
        @media (max-width: 576px) {
            .dashboard-container { padding: 25px 15px; }
