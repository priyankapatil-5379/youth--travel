...
<aside class="sidebar">
    <ul class="nav-menu">
        <li class="nav-item ${param.activePage == 'dashboard' ? 'active' : ''}">
            <a href="<c:url value='/user/dashboard'/>"><i class="fa fa-th-large"></i> Dashboard</a>
        </li>
        <li class="nav-item ${param.activePage == 'explore' ? 'active' : ''}">
            <a href="<c:url value='/user/explore'/>"><i class="fa fa-users"></i> Explore Users</a>
        </li>
        <li class="nav-item ${param.activePage == 'bookings' ? 'active' : ''}">
            <a href="<c:url value='/user/my-bookings'/>"><i class="fa fa-calendar-check-o"></i> My Bookings</a>
        </li>
        <li class="nav-item ${param.activePage == 'saved' ? 'active' : ''}">
            <a href="<c:url value='/user/saved-trips'/>"><i class="fa fa-heart-o"></i> Saved Trips</a>
        </li>
        <li class="nav-item ${param.activePage == 'reviews' ? 'active' : ''}">
            <a href="<c:url value='/user/my-reviews'/>"><i class="fa fa-star-o"></i> My Reviews</a>
        </li>
        <li class="nav-item ${param.activePage == 'payments' ? 'active' : ''}">
            <a href="<c:url value='/user/payments'/>"><i class="fa fa-credit-card"></i> Payments</a>
        </li>
        <li class="nav-item ${param.activePage == 'messages' ? 'active' : ''}">
            <a href="<c:url value='/user/messages'/>"><i class="fa fa-envelope-o"></i> Messages</a>
        </li>
        ...
        <li class="nav-item">
            <a href="<c:url value='/user/logout'/>"><i class="fa fa-sign-out"></i> Logout</a>
        </li>
    </ul>
</aside>
...
<style>
    ...
    @media (max-width: 991px) {
        ...
        .sidebar .nav-item a span { display: none; }
