...
<head>
    ...
    <style>
        ...
        .modal-close { color: var(--text-muted); transition: 0.2s; }
        .modal-close:hover { color: var(--accent-red); }

        .modal-tip-box { background: #f8fafc; border: 1px solid var(--border-color); border-radius: 12px; padding: 16px; }
        .modal-tip-label { color: var(--primary); font-weight: 700; font-size: 11px; text-transform: uppercase; margin-bottom: 8px; }
