...
<head>
    ...
    <title>Verify OTP | Youth Travel</title>
...
<div class="login-container">
    ...
    <form action="<c:url value='/user/verify-otp'/>" method="post">
        <div class="form-group">
            <label for="otp"><i class="fa fa-key"></i> One-Time Password</label>
    ...
    <div class="footer-links">
        <p><a href="<c:url value='/user/login'/>">Cancel</a></p>
    </div>
</div>
</body>
</html>
