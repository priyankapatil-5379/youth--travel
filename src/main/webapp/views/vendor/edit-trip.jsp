    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <style>
                ...
                .step-item.active .step-label { color: var(--accent-red) !important; font-weight: 700 !important; }

                /* Sidebar Overrides - MATCHING THE IMAGE */
                .sidebar {
                    background: #006d77 !important; /* Dark Sea Green/Teal from image */
                ...
                <form action="<c:url value='/vendor/edit-trip'/>" id="editForm" method="post"
                    ...
                    <div class="form-card">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div id="catOtherInputCont" style="display:none;" class="mt-2">
                                            ...
                                            <input type="text" name="travelerCategoryOther" value="${trip.travelerCategoryOther}" class="form-control" placeholder="e.g. Senior Citizens, School Groups...">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div id="subCategoryList" class="dropdown-menu p-3 bg-dark border-secondary w-100" style="background: #1a1f2b; max-height: 250px; overflow-y: auto;">
                                                <p class="text-muted small mb-0">Select Audience first...</p>
                                            </div>
                                        </div>
                                        <div id="subOtherInputCont" style="display:none;" class="mt-2">
                                            ...
                                            <input type="text" name="travelerSubCategoryOther" value="${trip.travelerSubCategoryOther}" class="form-control" placeholder="e.g. Photography, Yoga, Stargazing...">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" rows="3" placeholder="A brief, engaging overview...">${trip.description}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="coveringPlaces" value="${trip.coveringPlaces}" class="form-control" placeholder="e.g., Delhi, Agra, Jaipur, Varanasi">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="days" id="tripDays" class="form-control" value="${trip.days}" min="1" oninput="if(this.value < 1) this.value = 1; syncNights(this.value)">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Nights</label>
                                        <input type="number" name="nights" id="tripNights" class="form-control" value="${trip.nights}" min="0" oninput="if(this.value < 0) this.value = 0; updateDurationLabel()">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                        ...
                        <div class="form-step" id="step4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label class="small text-muted mb-2">Price Model</label>
                        ...
                        <div class="form-step" id="step5">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12 mt-3">
                                    <label class="small text-muted mb-3 d-block uppercase tracking-wider">Stay Photos (Multiple)</label>
                                    <div onclick="document.getElementById('stayPhotos').click()" class="p-4 border-2 border-dashed rounded text-center cursor-pointer" style="border: 2px dashed rgba(240, 76, 38, 0.3); background: rgba(240, 76, 38, 0.02);">
                                        ...
                                        <input type="file" id="stayPhotos" name="stayPhotos" accept="image/*" multiple class="d-none" onchange="previewStayImage(this)">
                                                                         ...
                                                                         <div id="stayPhotoPreview" class="d-flex flex-wrap gap-2 mt-2">
                                          <c:if test="${not empty trip.mediaUrls}">
                                              <c:forEach var="url" items="${trip.mediaUrls.split(',')}">
                                                  <c:if test="${url.contains('stay_')}">
                                                      <div class="existing-media" style="width: 80px; height: 80px; border-radius: 10px; overflow: hidden; border: 1px solid rgba(255,255,255,0.2);">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div onclick="document.getElementById('photoFiles').click()" class="p-4 border-2 border-dashed rounded text-center cursor-pointer" style="border: 2px dashed rgba(240, 76, 38, 0.3);">
                                        ...
                                        <input type="file" id="photoFiles" name="photoFiles" accept="image/*" multiple class="d-none" onchange="previewMedia(this, 'photoPreview')">
                                                                         ...
                                                                         <div id="photoPreview" class="d-flex flex-wrap gap-2 mt-2">
                                          <c:if test="${not empty trip.mediaUrls}">
                                              <c:forEach var="url" items="${trip.mediaUrls.split(',')}">
                                                  <c:if test="${(url.endsWith('.jpg') or url.endsWith('.jpeg') or url.endsWith('.png') or url.endsWith('.webp') or url.endsWith('.gif')) and not url.contains('stay_')}">
                                                      <div class="existing-media" style="width: 50px; height: 50px; border-radius: 8px; overflow: hidden; border: 1px solid rgba(255,255,255,0.2);">
                                                          <img src="${url}" style="width:100%; height:100%; object-fit:cover;">
                                                      </div>
                                                  </c:if>
                                              </c:forEach>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div onclick="document.getElementById('videoFiles').click()" class="p-4 border-2 border-dashed rounded text-center cursor-pointer" style="border: 2px dashed rgba(59, 130, 246, 0.3);">
                                        ...
                                        <input type="file" id="videoFiles" name="videoFiles" accept="video/*" multiple class="d-none" onchange="previewMedia(this, 'videoPreview')">
                                                                         ...
                                                                         <div id="videoPreview" class="d-flex flex-wrap gap-2 mt-2">
                                          <c:if test="${not empty trip.mediaUrls}">
                                              <c:forEach var="url" items="${trip.mediaUrls.split(',')}">
                                                  <c:if test="${url.endsWith('.mp4') or url.endsWith('.mov') or url.endsWith('.avi') or url.endsWith('.mkv')}">
                                                      <div class="existing-media" style="width: 50px; height: 50px; border-radius: 8px; overflow: hidden; border: 1px solid rgba(255,255,255,0.2); display:flex; align-items:center; justify-content:center; background:#000;">
                        ...
                        <div class="form-step" id="step11">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <textarea name="tripRules" class="form-control" rows="3" placeholder="e.g. No smoking during trek, respect local culture...">${trip.tripRules}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- SAVE BUTTON -->
                        <div class="d-flex justify-content-center mt-5 pt-4 border-top border-secondary">
                            <button type="submit" class="btn-submit w-100" id="launchBtn" style="max-width: 400px;">Update Adventure & Save Changes</button>
                        </div>
            ...
            <script>
                ...
                function jumpToStep(n) {
                    ...
                    if (steps[n]) {
                        ...
                        $('#stepIndicator' + (n + 1)).addClass('active');
                    }
                }
                ...
                function updateReview() {
                    ...
                    document.getElementById('rev_duration').innerText = (document.getElementById('tripDays')?.value || '0') + ' Days / ' + (document.getElementById('tripNights')?.value || '0') + ' Nights';
                    
                    document.getElementById('rev_audience').innerText = getChecked('travelerCategories');
                    document.getElementById('rev_subs').innerText = getChecked('travelerSubCategories');
                    
                    document.getElementById('rev_stay').innerText = (getVal('stayName') || 'N/A') + ' (' + (getVal('stayCategory') || 'N/A') + ')';
                    document.getElementById('rev_trans').innerText = (getVal('vehicleName') || 'N/A') + ' (' + (getVal('transportCategory') || 'N/A') + ')';
                    document.getElementById('rev_meals').innerText = getChecked('mealPlan');

                    // Dynamic Counts
                    const itinCount = document.querySelectorAll('.itinerary-day').length;
                    const pickupCount = document.querySelectorAll('.pickup-item').length;
                    const schedCount = document.querySelectorAll('.occ-card').length;
                    
                    document.getElementById('rev_mode').innerText = (document.getElementById('scheduleModeInput')?.value || 'specific') + ' (' + schedCount + ' dates)';
                    document.getElementById('rev_inclusions').innerText = getChecked('inclusions');
                ...
                document.getElementById('addDayBtn').addEventListener('click', () => {
                    ...
                    div.innerHTML = `
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-12 mb-3"><input type="text" class="form-control day-title" placeholder="Day Title"></div>
                ...
                function setScheduleMode(m, el) {
                    ...
                    if (m === 'recurring') { 
                        ...
                        // Remove from specific dates to avoid conflicts
                ...
                $('#editForm').on('submit', function(e) {
                    ...
                    // 3. Checkbox Lists (Amenities, Meals)
                    ...
                    if ($('#scheduleModeInput').val() === 'specific') {
                        ...
                        document.querySelectorAll('.occ-card').forEach(o => {
                            scheds.push({ 
                                date: o.querySelector('.occ-date').value, 
                                time: o.querySelector('.occ-time').value, 
                                seats: o.querySelector('.occ-seats').value 
                            });
                        });
                    ...
                    $btn.prop('disabled', true).html('<i class="fa fa-spinner fa-spin"></i> Saving Details...');
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            ...
                            alert("Error: Could not save details. Please check the form.");
                        }
                    });
                });
                ...
                $(document).ready(function() {
                    console.log("Initializing form re-hydration...");
                    try {
                        const stayCat = '${trip.stayCategory}';
                        const stayType = '${trip.stayType}';
                        if(stayCat) {
                            $('#stayCategory').val(stayCat).trigger('change');
                            if(stayType) setTimeout(() => $('#stayType').val(stayType), 100);
                        }
                        
                        const transCat = '${trip.transportCategory}';
                        const transType = '${trip.transportType}';
                        if(transCat) {
                            $('#transportCategory').val(transCat).trigger('change');
                            if(transType) setTimeout(() => $('#transportType').val(transType), 100);
                        }

                        if('${trip.difficulty}') $('select[name="difficulty"]').val('${trip.difficulty}');
                        if('${trip.region}') $('select[name="region"]').val('${trip.region}');
                        if('${trip.taxStatus}') $('select[name="taxStatus"]').val('${trip.taxStatus}');
                        if('${trip.pricingType}') setPricingType('${trip.pricingType}', $(`.pricing-toggle[onclick*="'${trip.pricingType}'"]`));
                        if('${trip.cancellationPolicy}') {
                            $('select[name="cancellationPolicy"]').val('${trip.cancellationPolicy}');
                            toggleCustomPolicy('${trip.cancellationPolicy}');
                        }

                        // Checkboxes & Radios (Boolean/String)
                        if('${trip.studentDiscountAvailable}' === 'true') $('input[name="studentDiscountAvailable"]').prop('checked', true);
                        if('${trip.acType}') $(`input[name="acType"][value="${trip.acType}"]`).prop('checked', true);
                    } catch(e) { console.error("Error in basic selects:", e); }

                    // 2. Checkboxes (CSV Strings)
                    const rehydrateCSV = (fieldName, csv) => {
                        if(!csv || csv === 'null') return;
                        const values = csv.split(',').map(v => v.trim()).filter(v => v !== "");
                    ...
                    rehydrateCSV('travelerCategories', `${trip.travelerCategory}`);
                    rehydrateCSV('inclusions', `${trip.inclusions}`);
                    rehydrateCSV('exclusions', `${trip.exclusions}`);
                    rehydrateCSV('mandatoryDocuments', `${trip.mandatoryDocuments}`);
                    
                    // Rehydrate Sub-Categories after a delay to allow updateSubCategories() to finish
                    setTimeout(() => {
                        rehydrateCSV('travelerSubCategories', `${trip.travelerSubCategory}`);
                    }, 800);

                    // 3. JSON Lists (Stay Amenities, Meals Config)
                    const rehydrateJSON = (cls, json) => {
                        ...
                        } catch(e) { console.error("JSON parse error for " + cls, e); }
                    };
                    rehydrateJSON('.stay-amenity', `${trip.stayAmenities}`);
                    rehydrateJSON('.meal-check', `${trip.mealsConfig}`);

                    // 4. Pickup Points (Dynamic List)
                    try {
                        let pickups = [];
                        const rawPickups = `${trip.pickupPoints}`;
                        if(rawPickups && rawPickups !== 'null' && rawPickups !== '[]') {
                            pickups = JSON.parse(rawPickups);
                            if(Array.isArray(pickups)) {
                                $('#selectedPickupTimes').empty();
                                pickups.forEach(p => addCustomPickup(p.name, p.time, p.type));
                            }
                        }
                    } catch(e) { console.error("Pickup re-hydration error:", e); }

                    // 5. Itinerary (Dynamic List)
                    try {
                        let itinerary = [];
                        const rawItinerary = `${trip.itinerary}`;
                        if(rawItinerary && rawItinerary !== 'null' && rawItinerary !== '[]') {
                                ...
                                itinerary.forEach((day, index) => {
                                    ...
                                    div.innerHTML = `
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col-12 mb-3"><input type="text" class="form-control day-title" value="\${day.title || ''}" placeholder="Day Title"></div>
                                                    <div class="col-12 mb-3"><textarea class="form-control day-activities" rows="2" placeholder="Activities...">\${day.activities || ''}</textarea></div>
                                                    <div class="col-6"><input type="text" class="form-control day-stay" value="\${day.stay || ''}" placeholder="Stay"></div>
                                                    <div class="col-6"><input type="text" class="form-control day-meals" value="\${day.meals || ''}" placeholder="Meals"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                    ...
                    } catch(e) { console.error("Itinerary re-hydration error:", e); }

                    // 6. Scheduling Mode
                    try {
                        const mode = '${trip.scheduleMode}';
                        if(mode) {
                            setScheduleMode(mode, $(`.pricing-toggle[onclick*="'${mode}'"]`));
                            if(mode === 'specific') {
                                const rawScheds = `${trip.schedulesJson}`;
                                if(rawScheds && rawScheds !== 'null' && rawScheds !== '[]') {
                                    const scheds = JSON.parse(rawScheds);
                                    if(Array.isArray(scheds)) {
                                        $('#occurrenceContainer').empty();
                                        scheds.forEach(s => {
                                            const today = new Date().toISOString().split('T')[0];
                    ...
                    } catch(e) { console.error("Scheduling re-hydration error:", e); }
